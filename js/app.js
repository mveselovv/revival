(() => {
    ...
    (s.autoplay = { running: !1, paused: !1 }),
      ...
      n("init", () => {
        if (s.params.autoplay.enabled) {
          o();
          l().addEventListener("visibilitychange", p),
      ...
      n("destroy", () => {
        ...
        l().removeEventListener("visibilitychange", p);
      }),
    ...
    oe(),
      document.querySelector(".swiper") &&
        new ie(".spectacle__slider", {
          ...
          autoHeight: !0,
          speed: 800,
          pagination: { el: ".spectacle__bullet", clickable: !0 },
          on: {},
        });
  });
  let le = !1;
  ...
  const de = document.querySelector("#posterShowMore"),
    ce = document.querySelectorAll(".poster__item:nth-child(n+4)");
  de.addEventListener("click", function (e) {
    e.preventDefault(),
      de.classList.add("active"),
      ce.forEach(function (e) {
        e.classList.toggle("poster__item-active"),
          e.classList.contains("poster__item-active") &&
